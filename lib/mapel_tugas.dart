...
class MapelTugasPage extends StatefulWidget {
  const MapelTugasPage({Key? key}) : super(key: key);

  @override
  _MapelTugasPageState createState() => _MapelTugasPageState();
}

class _MapelTugasPageState extends State<MapelTugasPage> {
                        ...
                        return Column(
                          children: [
                            _buildDashboardBox(
                              context,
                              mapel,
                              '/daftar_tugas', // Ganti dengan route yang sesuai
                              height: 70,
                              width: double.infinity,
                              onTap: () {
                                Navigator.pushNamed(context, '/daftar_tugas',
                                    arguments: mapel);
                              },
                            ),
                            const SizedBox(
